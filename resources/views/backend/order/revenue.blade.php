            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Doanh thu : {{ number_format($revenue) }}</h3>
                        <div class="card-tools">
                            <form action="" method="GET">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <select name="sort" onchange="this.form.submit()">
                                        <option @if($sort == 'all') selected @endif value="all">Tổng doanh thu</option>
                                        <option @if($sort == 'month') selected @endif value="month">Tháng này</option>
                                        <option @if($sort == 'year') selected @endif value="year">Năm nay</option>
                                    </select>
                                </div>
                            </form>
                        </div>
